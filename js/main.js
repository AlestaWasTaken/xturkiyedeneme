...
function toggleMenu() {
    var menu = document.querySelector(".mil-menu-content");
    menu.classList.toggle("mil-active"); // Navbar aktiflik durumunu değiştir
}

document.addEventListener('DOMContentLoaded', function() {
    const sliders = document.querySelectorAll('.mil-artist-track');
    
    // İçeriği kopyala ve ekle
    sliders.forEach(track => {
        track.innerHTML += track.innerHTML;
        
        // Slider genişliğini ayarla
        const items = track.querySelectorAll('.mil-artist-item');
